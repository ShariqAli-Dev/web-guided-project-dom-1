...
const homeTag = Array.from(anchorTags).find(a => a.textContent === 'Home')
// D- Use .filter to find the anchor tag with the textContent of "Home"
console.log(homeTag)

// 👉 3- Changing an element's text content
//  A- Change the cat-related content into dog-related content
titleFirstCard.textContent = 'Dog in a Raincoat'
// imageFirstCard.src = 'https://i2.wp.com/bestlifeonline.com/wp-content/uploads/2019/12/shutterstock_1120210925.jpg?resize=1024%2C684&ssl=1'
imageFirstCard.setAttribute('src', 'https://i2.wp.com/bestlifeonline.com/wp-content/uploads/2019/12/shutterstock_1120210925.jpg?resize=1024%2C684&ssl=1')
link2FirstCard.setAttribute('alt', 'Dog Ipsum')
link2FirstCard.innerText = 'Dog Ipsum'
